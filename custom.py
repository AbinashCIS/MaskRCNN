...
class CustomConfig(Config):
	...
	NUM_CLASSES = 1 + 7   # Background + number of classes (Here, 2)
...
class CustomDataset(utils.Dataset):
	...
	def load_custom(self, dataset_dir, subset):
		...
		self.add_class("custom", 1, "object")
		self.add_class("custom", 2, "ceiling")
		self.add_class("custom", 3, "floor")
		self.add_class("custom", 4, "price_tag")
		self.add_class("custom", 5, "shelf_bar")
		self.add_class("custom", 6, "shelf_back")
		self.add_class("custom", 7, "shelf_bar_vertical")
			...
			for n in custom:
				try:
					if n['name']=='ceiling':
						...
						num_ids.append(3)
					elif n['name']=='price_tags':
						num_ids.append(4)
					elif n['name']=='shelf_bar':
						num_ids.append(5)
					elif n['name']=='shelf_back':
						num_ids.append(6)
					elif n['name']=='shelf_bar_vertical':
						num_ids.append(7)
				except:
					pass
